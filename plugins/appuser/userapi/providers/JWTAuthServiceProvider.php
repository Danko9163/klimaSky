<?php namespace AppUser\UserApi\Providers;

use AppUser\UserApi\Classes\JWTAuth;
...
class JWTAuthServiceProvider extends AbstractServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->app->alias('JWTAuth', 'AppUser\UserApi\Facades\JWTAuth');
    ...
    {
        return config("appuser.userapi::$key",
